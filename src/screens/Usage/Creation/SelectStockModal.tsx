...
import { View, Text, TouchableOpacity, Modal, TextInput, FlatList, ActivityIndicator, RefreshControl, Dimensions, KeyboardAvoidingView, Platform } from "react-native";
                    ...
                    <View className="flex flex-row justify-between items-center py-3" >
                      <View className="flex flex-col">
                        <Text className="font-bold text-lg">
                          {t("medications.expiresOn", { date: getDateAndHour(new Date(item.expirationDate))?.split(",")?.[0] })}
                        </Text>
                        <Text className="">
